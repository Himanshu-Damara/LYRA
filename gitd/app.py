...
from gitd.models import task_review as _task_review_models  # noqa: F401 - register ORM tables
from gitd.models import gmail as _gmail_models  # noqa: F401 - register ORM tables
...
from gitd.routers.task_review import router as task_review_router
from gitd.routers.gmail import router as gmail_router

logger = logging.getLogger(__name__)

# Default CORS allowlist â€” the local dashboard (Vite dev server, port 6175)
...
async def lifespan(app: FastAPI):
    ...
    from gitd.routers.task_review import seed_review_tasks
...
TAGS_METADATA = [
    ...
    {"name": "benchmarks", "description": "Benchmark runner â€” task suites, live progress, results"},
]
...
def create_app() -> FastAPI:
    ...
    # Premium tab registry â€” plugins append to this list
    ...
    app.include_router(task_review_router)

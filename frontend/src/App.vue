...
const coreTabs = [
  { id: 'phone', label: 'ðŸ‘» Phone Agent' },
  { id: 'skills', label: 'ðŸ§© Skill Hub' },
  { id: 'task-review', label: 'ðŸ§¾ Task Review' },
  { id: 'gmail', label: 'âœ‰ï¸ Gmail' },
]
...
// Status ghost â€” polls device state for header mascot
...
<template>
  <div class="min-h-screen" style="background: var(--bg-base)">
      ...
      <div class="flex items-center justify-between mb-4">
        ...
        <div class="flex items-center gap-3">
          ...
          <button @click="restartServer" :disabled="restarting"
            ...
            {{ restarting ? 'âŸ³ Restarting...' : 'âŸ³ Restart Server' }}
          </button>
        </div>
      </div>
    ...
    <div class="px-6 py-4">
      ...
      <TaskReviewView v-else-if="activeTab === 'task-review'" />
      <GmailView v-else-if="activeTab === 'gmail'" />
